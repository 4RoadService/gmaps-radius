/*! Made by Oliver Beattie. Built 2017-08-25 */
...
;return!0===b?(this._fragmentURI=e=f.substring(0,e.length)!==e?a(""):new a(f.substring(e.length)),e._parentURI=this,e):void 0!==b&&"string"!=typeof b?(this._fragmentURI=b,b._parentURI=b,this._parts.fragment=e+b.toString(),this.build(!d),this):("string"==typeof b&&(this._fragmentURI=void 0),c.call(this,b,d))},b.build=function(a){var b=d.call(this,a);return!1!==a&&this._parentURI&&this._parentURI.fragment(this),b},a}),function(){$(function(){var a,b,c,d,e,f,g,h,i,j,k,l,m;return h=[],g=new google.maps.Map($("#map")[0],{zoom:10,center:new google.maps.LatLng(45.5036922,-73.5791619),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),f={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},e=!1,window.onkeydown=function(a){return e="Control"===a.keyIdentifier||"MetaLeft"===a.code||"MetaRight"===a.code||!0===a.ctrlKey,!0},window.onkeyup=function(a){return e=!1,!0},j=function(){return this.setMap(null)},c=function(){var a,b,c;for(a=0,b=h.length;a<b;a++)c=h[a],c.setMap(null);return h=[]},i=function(a){var b;return b=new google.maps.Marker({position:a.latLng}),b.setMap(g),google.maps.event.addListener(b,"rightclick",j),google.maps.event.addListener(b,"click",d)},a=function(a){var c,d,e,h;return e=$("#unitSelector"),h=$("option",e).eq(e[0].selectedIndex).val(),d=parseFloat(document.getElementById("radiusInput").value),d=d/f[h]*f.mt,c=new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!0,geodesic:!0,editable:!0,fillColor:"#004de8",fillOpacity:.27,map:g,radius:d,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),c.infoWindow=new google.maps.InfoWindow({disableAutoPan:!0}),c.infoWindow.isOpen=!1,b.call(c),google.maps.event.addListener(c,"rightclick",j),google.maps.event.addListener(c,"bounds_changed",b),google.maps.event.addListener(c,"click",function(a){return this.infoWindow.isOpen?(this.infoWindow.close(),this.infoWindow.isOpen=!1):(this.infoWindow.open(g),this.infoWindow.isOpen=!0)}),google.maps.event.addListener(c.infoWindow,"closeclick",function(a){return this.isOpen=!1})},b=function(a){var b;return b="<pre>Radius (km): "+this.getRadius()/1e3+"\n",b+="Center     : "+this.getCenter().lat()+", "+this.getCenter().lng()+"</pre>",this.infoWindow.setContent(b),this.infoWindow.setPosition(this.getCenter())},d=function(b){return e?i(b):a(b)},google.maps.event.addListener(g,"click",d),l=document.getElementById("searchInput"),$(l.form).on({submit:function(){return!1}}),k=new google.maps.places.SearchBox(l),google.maps.event.addListener(k,"places_changed",function(){var a;c(),null!=(a=k.getPlaces()[0])&&(null!=a.geometry.viewport?(g.fitBounds(a.geometry.viewport),g.panToBounds(a.geometry.viewport)):g.setCenter(a.geometry.location),h.push(new google.maps.Marker({position:a.geometry.location,map:g,title:a.name,clickable:!1})))}),m=function(){var a,b,c,d;return a=g.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:g.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,d=new URI,d.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,d.toString()):void 0},google.maps.event.addListener(g,"bounds_changed",_.debounce(m,200)),google.maps.event.addListener(g,"zoom_changed",m),$("#unitSelector, #radiusInput").on("change",m),document.querySelector("#options").addEventListener("submit",function(a){return a.preventDefault(),!1}),$(window).on("hashchange",function(a){var b,c,d,e,f;if(e=(new URI).query(!0),c=g.getCenter(),b=[c.lat(),c.lng()],d=[b[0],b[1]],null!=e.lat&&(d[0]=parseFloat(e.lat)),null!=e.lng&&(d[1]=parseFloat(e.lng)),0===$.grep(d,isNaN).length&&g.setCenter({lat:d[0],lng:d[1]}),null!=e.z&&(f=parseInt(e.z,10),isNaN(f)||g.setZoom(f)),null!=e.r&&$("#radiusInput").val(e.r),null!=e.u)return $("#unitSelector").val(e.u)}).triggerHandler("hashchange")})}.call(this);
