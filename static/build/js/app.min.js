...
;return!0===b?(this._fragmentURI=e=f.substring(0,e.length)!==e?a(""):new a(f.substring(e.length)),e._parentURI=this,e):void 0!==b&&"string"!=typeof b?(this._fragmentURI=b,b._parentURI=b,this._parts.fragment=e+b.toString(),this.build(!d),this):("string"==typeof b&&(this._fragmentURI=void 0),c.call(this,b,d))},b.build=function(a){var b=d.call(this,a);return!1!==a&&this._parentURI&&this._parentURI.fragment(this),b},a}),function(){$(function(){var a,b,c,d,e,f,g,h,i,j;return e=[],d=new google.maps.Map($("#map")[0],{zoom:10,center:new google.maps.LatLng(51.500358,-.125506),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),c={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},g=function(){return this.setMap(null)},b=function(){var a,b,c;for(a=0,b=e.length;a<b;a++)c=e[a],c.setMap(null);return e=[]},f=function(b){var c;return c=new google.maps.Marker({position:b.latLng}),c.setMap(d),google.maps.event.addListener(c,"rightclick",g),google.maps.event.addListener(c,"click",a)},a=function(a){var b,e,h,i;return h=$("#unitSelector"),i=$("option",h).eq(h[0].selectedIndex).val(),e=parseFloat(document.getElementById("radiusInput").value),e=e/c[i]*c.mt,b=new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!1,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:d,radius:e,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),google.maps.event.addListener(b,"rightclick",g),google.maps.event.addListener(b,"click",f)},google.maps.event.addListener(d,"click",f),i=document.getElementById("searchInput"),$(i.form).on({submit:function(){return!1}}),h=new google.maps.places.SearchBox(i),google.maps.event.addListener(h,"places_changed",function(){var a;b(),null!=(a=h.getPlaces()[0])&&(null!=a.geometry.viewport?(d.fitBounds(a.geometry.viewport),d.panToBounds(a.geometry.viewport)):d.setCenter(a.geometry.location),e.push(new google.maps.Marker({position:a.geometry.location,map:d,title:a.name,clickable:!1})))}),j=function(){var a,b,c,e;return a=d.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:d.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,e=new URI,e.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,e.toString()):void 0},google.maps.event.addListener(d,"bounds_changed",_.debounce(j,200)),google.maps.event.addListener(d,"zoom_changed",j),$("#unitSelector, #radiusInput").on("change",j),$(window).on("hashchange",function(a){var b,c,e,f,g;if(f=(new URI).query(!0),c=d.getCenter(),b=[c.lat(),c.lng()],e=[b[0],b[1]],null!=f.lat&&(e[0]=parseFloat(f.lat)),null!=f.lng&&(e[1]=parseFloat(f.lng)),0===$.grep(e,isNaN).length&&d.setCenter({lat:e[0],lng:e[1]}),null!=f.z&&(g=parseInt(f.z,10),isNaN(g)||d.setZoom(g)),null!=f.r&&$("#radiusInput").val(f.r),null!=f.u)return $("#unitSelector").val(f.u)}).triggerHandler("hashchange")})}.call(this);
