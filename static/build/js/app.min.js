...
;return!0===b?(this._fragmentURI=e=f.substring(0,e.length)!==e?a(""):new a(f.substring(e.length)),e._parentURI=this,e):void 0!==b&&"string"!=typeof b?(this._fragmentURI=b,b._parentURI=b,this._parts.fragment=e+b.toString(),this.build(!d),this):("string"==typeof b&&(this._fragmentURI=void 0),c.call(this,b,d))},b.build=function(a){var b=d.call(this,a);return!1!==a&&this._parentURI&&this._parentURI.fragment(this),b},a}),function(){$(function(){var a,b,c,d,e,f,g,h,i,j,k,l,m,n;return i=[],h=new google.maps.Map($("#map")[0],{zoom:10,center:new google.maps.LatLng(45.5036922,-73.5791619),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),f={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},e=!1,window.onkeydown=function(a){return e="Control"===a.keyIdentifier||"MetaLeft"===a.code||"MetaRight"===a.code||!0===a.ctrlKey,!0},window.onkeyup=function(a){return e=!1,!0},k=function(){return null!=this.infoWindow&&this.infoWindow.setMap(null),this.setMap(null)},c=function(){var a,b,c;for(a=0,b=i.length;a<b;a++)c=i[a],c.setMap(null);return i=[]},j=function(a){var b;return b=new google.maps.Marker({position:a.latLng}),b.setMap(h),google.maps.event.addListener(b,"rightclick",k),google.maps.event.addListener(b,"click",d)},a=function(a){var c,d,e,g;return e=$("#unitSelector"),g=$("option",e).eq(e[0].selectedIndex).val(),d=parseFloat(document.getElementById("radiusInput").value),d=d/f[g]*f.mt,c=new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!0,geodesic:!0,editable:!0,fillColor:"#004de8",fillOpacity:.27,map:h,radius:d,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),c.infoWindow=new google.maps.InfoWindow({disableAutoPan:!0}),c.infoWindow.isOpen=!1,b.call(c),google.maps.event.addListener(c,"rightclick",k),google.maps.event.addListener(c,"bounds_changed",b),google.maps.event.addListener(c,"click",function(a){return this.infoWindow.isOpen?(this.infoWindow.close(),this.infoWindow.isOpen=!1):(this.infoWindow.open(h),this.infoWindow.isOpen=!0)}),google.maps.event.addListener(c.infoWindow,"closeclick",function(a){return this.isOpen=!1})},b=function(a){var b;return b="<pre>Radius (km): "+this.getRadius()/1e3+"\n",b+="Center     : "+this.getCenter().lat()+", "+this.getCenter().lng()+"</pre>",this.infoWindow.setContent(b),this.infoWindow.setPosition(this.getCenter())},d=function(b){return e?j(b):a(b)},google.maps.event.addListener(h,"click",d),m=document.getElementById("searchInput"),$(m.form).on({submit:function(){return!1}}),l=new google.maps.places.SearchBox(m),google.maps.event.addListener(l,"places_changed",function(){var a;c(),null!=(a=l.getPlaces()[0])&&(null!=a.geometry.viewport?(h.fitBounds(a.geometry.viewport),h.panToBounds(a.geometry.viewport)):h.setCenter(a.geometry.location),i.push(new google.maps.Marker({position:a.geometry.location,map:h,title:a.name,clickable:!1})))}),g=function(a){var b;return b=document.getElementById("help"),"none"===b.style.display?b.style.display="block":b.style.display="none"},n=function(){var a,b,c,d;return a=h.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:h.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,d=new URI,d.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,d.toString()):void 0},google.maps.event.addListener(h,"bounds_changed",_.debounce(n,200)),google.maps.event.addListener(h,"zoom_changed",n),$("#unitSelector, #radiusInput").on("change",n),document.querySelector("#options").addEventListener("submit",function(a){return a.preventDefault(),!1}),$("#help, #gethelp").on("click",g),$(window).on("hashchange",function(a){var b,c,d,e,f;if(e=(new URI).query(!0),c=h.getCenter(),b=[c.lat(),c.lng()],d=[b[0],b[1]],null!=e.lat&&(d[0]=parseFloat(e.lat)),null!=e.lng&&(d[1]=parseFloat(e.lng)),0===$.grep(d,isNaN).length&&h.setCenter({lat:d[0],lng:d[1]}),null!=e.z&&(f=parseInt(e.z,10),isNaN(f)||h.setZoom(f)),null!=e.r&&$("#radiusInput").val(e.r),null!=e.u)return $("#unitSelector").val(e.u)}).triggerHandler("hashchange")})}.call(this);
