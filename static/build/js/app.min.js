...
;return!0===b?(this._fragmentURI=e=f.substring(0,e.length)!==e?a(""):new a(f.substring(e.length)),e._parentURI=this,e):void 0!==b&&"string"!=typeof b?(this._fragmentURI=b,b._parentURI=b,this._parts.fragment=e+b.toString(),this.build(!d),this):("string"==typeof b&&(this._fragmentURI=void 0),c.call(this,b,d))},b.build=function(a){var b=d.call(this,a);return!1!==a&&this._parentURI&&this._parentURI.fragment(this),b},a}),function(){$(function(){var a,b,c,d,e,f,g,h,i,j,k,l;return g=[],f=new google.maps.Map($("#map")[0],{zoom:10,center:new google.maps.LatLng(45.5036922,-73.5791619),mapType:google.maps.MapTypeId.ROADMAP,disableDefaultUI:!0,mapTypeControl:!0,zoomControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DROPDOWN_MENU,position:google.maps.ControlPosition.TOP_RIGHT},zoomControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT}}),e={mi:3963.1676,km:6378.1,ft:20925524.9,mt:6378100,in:251106299,yd:6975174.98,fa:3487587.49,na:3443.89849,ch:317053.408,rd:1268213.63,fr:31705.3408},d=!1,window.onkeydown=function(a){return d="Control"===a.keyIdentifier||"MetaLeft"===a.code||"MetaRight"===a.code||!0===a.ctrlKey,!0},window.onkeyup=function(a){return d=!1,!0},i=function(){return this.setMap(null)},b=function(){var a,b,c;for(a=0,b=g.length;a<b;a++)c=g[a],c.setMap(null);return g=[]},h=function(a){var b;return b=new google.maps.Marker({position:a.latLng}),b.setMap(f),google.maps.event.addListener(b,"rightclick",i),google.maps.event.addListener(b,"click",c)},a=function(a){var b,d,g,h;return g=$("#unitSelector"),h=$("option",g).eq(g[0].selectedIndex).val(),d=parseFloat(document.getElementById("radiusInput").value),d=d/e[h]*e.mt,b=new google.maps.Circle({center:a.latLng,clickable:!0,draggable:!0,geodesic:!0,editable:!1,fillColor:"#004de8",fillOpacity:.27,map:f,radius:d,strokeColor:"#004de8",strokeOpacity:.62,strokeWeight:1}),google.maps.event.addListener(b,"rightclick",i),google.maps.event.addListener(b,"click",c)},c=function(b){return d?h(b):a(b)},google.maps.event.addListener(f,"click",c),k=document.getElementById("searchInput"),$(k.form).on({submit:function(){return!1}}),j=new google.maps.places.SearchBox(k),google.maps.event.addListener(j,"places_changed",function(){var a;b(),null!=(a=j.getPlaces()[0])&&(null!=a.geometry.viewport?(f.fitBounds(a.geometry.viewport),f.panToBounds(a.geometry.viewport)):f.setCenter(a.geometry.location),g.push(new google.maps.Marker({position:a.geometry.location,map:f,title:a.name,clickable:!1})))}),l=function(){var a,b,c,d;return a=f.getCenter(),b={lat:_.round(a.lat(),6).toString(),lng:_.round(a.lng(),6).toString(),z:f.getZoom().toString(),u:$("#unitSelector").val(),r:$("#radiusInput").val()},b.r||delete b.r,d=new URI,d.setQuery(b),null!=(c=window.history)&&"function"==typeof c.replaceState?c.replaceState(null,null,d.toString()):void 0},google.maps.event.addListener(f,"bounds_changed",_.debounce(l,200)),google.maps.event.addListener(f,"zoom_changed",l),$("#unitSelector, #radiusInput").on("change",l),$(window).on("hashchange",function(a){var b,c,d,e,g;if(e=(new URI).query(!0),c=f.getCenter(),b=[c.lat(),c.lng()],d=[b[0],b[1]],null!=e.lat&&(d[0]=parseFloat(e.lat)),null!=e.lng&&(d[1]=parseFloat(e.lng)),0===$.grep(d,isNaN).length&&f.setCenter({lat:d[0],lng:d[1]}),null!=e.z&&(g=parseInt(e.z,10),isNaN(g)||f.setZoom(g)),null!=e.r&&$("#radiusInput").val(e.r),null!=e.u)return $("#unitSelector").val(e.u)}).triggerHandler("hashchange")})}.call(this);
